...
PVVwE.prototype.incrementFrom = function(ec){
	...
	this.vector.put(ec._e, {v: 0, LRU(this.options)});
    };
...
PVVwE.prototype.isRdy = function(ec){
	...
	if (!this.vector.has(ec._c)){
	    ready = true; // (TODO) default parameter ? 
	} else {
	    var vwe = this.vector.get(ec._c);
